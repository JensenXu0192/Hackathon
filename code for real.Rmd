...
Model.RanFor <- randomForest(formula =churn~.-bill_city,
                              data =est.d,
                              importance = TRUE,
                              ntree = 500, mtry = 4)
...
# test set
# Predicting on train set
pred <- predict(Model.RanFor, hold.d,type="prob")
pred%>%as.data.frame()->pred
resutl
pred$`1`->pred
hold.d$ph_num
write.csv(sub, 'yourteamname.csv')
